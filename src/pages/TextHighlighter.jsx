...
const TextHighlighter = () => {
  const [text, setText] = useState(() => {
    // Restore text from sessionStorage on mount
    return sessionStorage.getItem('highlighterText') || '';
  });
  const [varClave, setVariable] = useState(() => {
    // Restore varClave from sessionStorage on mount
    return sessionStorage.getItem('highlighterVarClave') || 'C';
  });
